        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <section class="section sign-in inner-right-xs">
                    ...
                    ?>
                    <?php echo $form->field($model, 'login_name')->textInput(['class' => 'le-input']); ?>
            ...
            <div class="col-md-6">
                <section class="section register inner-left-xs">
                    ...
                    <?= $form->field($model, 'user_email')->textInput(['class' => 'le-input'])?>
                    <div class="buttons-holder">
...
<script>
    ...
    login_qq.onclick = function(){
        window.location.href="<?= yii\helpers\Url::to(['member/login_qq']);?>";
    }
</script>